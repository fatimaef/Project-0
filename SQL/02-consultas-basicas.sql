...
select "Track"."Name" as "Track.Title" , "Milliseconds"
from "Track" 
...
select concat("FirstName" ,' ', "LastName") as "Name" , "Email" as "Email_Adress" , "Country"
from "Customer" c 
...
select concat("FirstName" ,' ', "LastName") as "Employee", "Title"
from "Employee" e 
...
select concat("FirstName" , ' ' , "LastName") as "Customers" , "SupportRepId" 
from "Customer" c 
